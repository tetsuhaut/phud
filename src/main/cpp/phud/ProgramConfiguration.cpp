...
ProgramConfiguration::Configuration ProgramConfiguration::readConfiguration(std::span<const char* const> args) {
  ...
  const auto loggingPattern = config.loggingPattern.has_value() ? config.loggingPattern.value() : DEFAULT_LOGGING_PATTERN;
