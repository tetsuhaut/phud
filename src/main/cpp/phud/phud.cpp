...
// GOOD PRACTISE: ensure the required headers are included without relying on a specific STL
// implementation GOOD PRACTISE: pour tous les constructeurs, vérifier que tous les attributs sont
// initialisés
