...
// PFR = PreFlop Raise = (preflop bets + preflop raises) / (preflop calls + preflop bet + preflop raises + preflop checks + preflop folds)
// Agression factor = (bets + raises) / calls
...
public:
   ...
   * any blind postings.
   */
  [[nodiscard]] constexpr int getVoluntaryPutMoneyInPot() const noexcept { return limits::toInt(m_voluntaryPutMoneyInPot); }
   ...
   */
  [[nodiscard]] constexpr int getPreFlopRaise() const noexcept { return limits::toInt(m_preflopRaise); }
   ...
   */
  [[nodiscard]] constexpr double getLimpOrCallPreFlopRaise() const noexcept { return m_limpOrCallPreFlopRaise; }

  [[nodiscard]] constexpr double getFoldToPreFlopRaise() const noexcept { return m_foldToPreFlopRaise; }
  [[nodiscard]] constexpr double getPreflopThreeBet() const noexcept { return m_preFlopThreeBet; }
  [[nodiscard]] constexpr double getFoldToThreeBet() const noexcept { return m_foldToPreFlopThreeBet; }
  ...
  [[nodiscard]] constexpr double getFlopContinuationBet() const noexcept { return m_flopContinuationBet; }
  [[nodiscard]] constexpr double getFoldToFlopContinuationBet() const noexcept { return m_foldToFlopContinuationBet; }
  [[nodiscard]] constexpr double getCallFlopContinuationBet() const noexcept { return m_callFlopContinuationBet; }
  [[nodiscard]] constexpr double getRaiseAfterFlopContinuationBet() const noexcept { return m_raiseAfterFlopContinuationBet; }
  [[nodiscard]] constexpr double getFoldToRaiseAfterFlopContinuationBet() const noexcept { return m_foldToRaiseAfterFlopContinuationBet; }
  [[nodiscard]] constexpr double getTurnContinuationBet() const noexcept { return m_turnContinuationBet; }
  [[nodiscard]] constexpr double getFoldToTurnContinuationBet() const noexcept { return m_foldToTurnContinuationBet; }
  [[nodiscard]] constexpr double getCallTurnContinuationBet() const noexcept { return m_callTurnContinuationBet; }
  [[nodiscard]] constexpr double getRaiseAfterTurnContinuationBet() const noexcept { return m_raiseAfterTurnContinuationBet; }
  [[nodiscard]] constexpr double getFoldToRaiseAfterTurnContinuationBet() const noexcept { return m_foldToRaiseAfterTurnContinuationBet; }
  [[nodiscard]] constexpr double getRiverContinuationBet() const noexcept { return m_riverContinuationBet; }
  [[nodiscard]] constexpr double getFoldToRiverContinuationBet() const noexcept { return m_foldToRiverContinuationBet; }
  [[nodiscard]] constexpr double getCallRiverContinuationBet() const noexcept { return m_callRiverContinuationBet; }
  [[nodiscard]] constexpr double getRaiseAfterRiverContinuationBet() const noexcept { return m_raiseAfterRiverContinuationBet; }
  [[nodiscard]] constexpr double getFoldToRaiseAfterRiverContinuationBet() const noexcept { return m_foldToRaiseAfterRiverContinuationBet; }
  ...
  [[nodiscard]] constexpr double getRaiseAfterDonkBet() const noexcept { return m_raiseAfterDonkBet; }
  [[nodiscard]] constexpr double getFoldToRaiseAfterDonkBet() const noexcept { return m_foldToRaiseAfterDonkBet; }
  [[nodiscard]] constexpr double getFlopCheckRaise() const noexcept { return m_flopCheckRaise; }
  [[nodiscard]] constexpr double getCallFlopCheckRaise() const noexcept { return m_callFlopCheckRaise; }
  [[nodiscard]] constexpr double getFoldToFlopCheckRaise() const noexcept { return m_foldToFlopCheckRaise; }
