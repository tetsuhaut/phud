...
static constexpr std::string_view APP_LONG_NAME_AND_VERSION {
  PHUD_APP_NAME_LONG " - Version " PHUD_APP_VERSION
};

static constexpr std::string_view WINAMAX_EXECUTABLE_STEM {
  "Winamax Poker"
};

static constexpr std::string_view WINAMAX_SITE_NAME {
  "Winamax"
};

static constexpr std::string_view PMU_EXECUTABLE_STEM {
  "PMU"
};

static constexpr std::string_view PMU_SITE_NAME {
  "Pmu"
};
