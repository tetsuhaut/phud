...
[[nodiscard]] inline String toString(auto s) = delete;
template<> inline String toString<StringView>(StringView s) { return String(s); }
template<> inline String toString<char>(char s) { return String(1, s); }
template<> inline String toString<const char*>(const char* const s) { return s; }
template<> inline String toString<bool>(bool s) { return s ? "1" : "0"; }
template<> inline String toString<int>(int s) { return std::to_string(s); }
template<> inline String toString<std::size_t>(std::size_t s) { return std::to_string(s); }
template<> inline String toString<double>(double s) { return std::to_string(s); }
template<> inline String toString<Seat>(Seat seat) { return tableSeat::toString(seat).data(); }
...
SqlInsertor::SqlInsertor(StringView sqlTemplate)
...
SqlInsertor& SqlInsertor::siteName(StringView value) { REPLACE_IN_VALUES("?siteName"); }
SqlInsertor& SqlInsertor::isHero(bool value) { REPLACE_IN_VALUES("?isHero"); }
SqlInsertor& SqlInsertor::comments(StringView value) { REPLACE_IN_VALUES("?comments"); }
SqlInsertor& SqlInsertor::playerSeat(Seat value) { REPLACE_IN_VALUES("?playerSeat"); }
SqlInsertor& SqlInsertor::playerName(StringView value) { REPLACE_IN_VALUES("?playerName"); }
SqlInsertor& SqlInsertor::isWinner(bool value) { REPLACE_IN_VALUES("?isWinner"); }
SqlInsertor& SqlInsertor::tableName(StringView value) { REPLACE_IN_VALUES("?tableName"); }
...
SqlInsertor& SqlInsertor::gameId(StringView value) { REPLACE_IN_VALUES("?gameId"); }
SqlInsertor& SqlInsertor::gameName(StringView value) { REPLACE_IN_VALUES("?gameName"); }
SqlInsertor& SqlInsertor::handId(StringView value) { REPLACE_IN_VALUES("?handId"); }
...
SqlInsertor& SqlInsertor::startDate(StringView value) { REPLACE_IN_VALUES("?startDate"); }
SqlInsertor& SqlInsertor::tournamentId(StringView value) { REPLACE_IN_VALUES("?tournamentId"); }
SqlInsertor& SqlInsertor::buyIn(double value) { REPLACE_IN_VALUES("?buyIn"); }
SqlInsertor& SqlInsertor::cashGameId(StringView value) { REPLACE_IN_VALUES("?cashGameId"); }
...
String formatSQL(StringView sql) {
