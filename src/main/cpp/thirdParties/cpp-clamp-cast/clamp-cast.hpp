// from https://github.com/e00E/cpp-clamp-cast
#pragma once
...
namespace clamp_cast {
  ...
  namespace detail {
    ...
    template <typename T>
    [[nodiscard]] constexpr T exp2(int exp) noexcept {
    ...
    template <typename T>
    [[nodiscard]] constexpr int exponent_bits() noexcept {
  ...
  template <typename T>
  [[nodiscard]] constexpr bool is_nan(T t) noexcept {
