...
constexpr std::string_view invalidChoice {
    "The chosen entry is not a valid Winamax history directory"};
...
constexpr std::string_view NO_HAND_HISTORY_DIRECTORY_SELECTED {
    "<no hand history directory selected>"};
