 ...
 * -if hero is at seat 1: rotate of 6 in 9 max table, 4 in 6 max table, 3 in 5 max table, 2 in 3 max
 * table, 1 in 2 max table -if hero is at seat 2: rotate of 5 in 9 max table, 3 in 6 max table, 2 in
 * 5 max table, 1 in 3 max table, 0 in 2 max table -if hero is at seat 3: rotate of 4 in 9 max
 * table, 2 in 6 max table, 1 in 5 max table, 0 in 3 max table -if hero is at seat 4: rotate of 3 in
 * 9 max table, 1 in 6 max table, 0 in 5 max table, -if hero is at seat 5: rotate of 2 in 9 max
 * table, 0 in 6 max table, 4 in 5 max table, -if hero is at seat 6: rotate of 1 in 9 max table, 5
 * in 6 max table -if hero is at seat 7: rotate of 0 in 9 max table -if hero is at seat 8: rotate of
 * 8 in 9 max table -if hero is at seat 9: rotate of 7 in 9 max table
 */
...
gui::buildPlayerIndicatorPosition(Seat seat, Seat tableMaxSeats, const phud::Rectangle& tablePos) {
