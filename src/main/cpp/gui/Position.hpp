...
namespace gui {
   ...
   * - if hero is at seat 1 -> rotate of 6 in 9 max table, 4 in 6 max table, 3 in 5 max table, 2 in
   * 3 max table, 0 in 2 max table
   * - if hero is at seat 2 -> rotate of 5 in 9 max table, 3 in 6 max table, 2 in 5 max table, 1 in
   * 3 max table, 1 in 2 max table
   * - if hero is at seat 3 -> rotate of 4 in 9 max table, 2 in 6 max table, 1 in 5 max table, 0 in
   * 3 max table
