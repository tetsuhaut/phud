...
BOOST_AUTO_TEST_CASE(FilesystemTest_readingFileShouldSucceed) {
  /* phud\src\test\resources\sabre_laser\history\20150630_Super Freeroll Stade 1 - D├®glingos
   * _(123322389)_real_holdem_no-limit.txt */
  const auto& file {
      pt::getFileFromTestResources(u8"Winamax/sabre_laser/history/20150630_Super Freeroll Stade 1 "
...
BOOST_AUTO_TEST_CASE(TextFileTest_readFileToStringsShouldSucceed) {
  BOOST_TEST(!pf::readToString(
                  pt::getFileFromTestResources("Winamax/sabre_laser/history/20141116_Double or "
