...
BOOST_AUTO_TEST_CASE(RectangleTest_valueConstruction) {
  const phud::Rectangle rect{10, 20, 100, 50};
...
BOOST_AUTO_TEST_CASE(RectangleTest_copyConstruction) {
  const phud::Rectangle rect1{10, 20, 100, 50};
  const phud::Rectangle rect2 { rect1 };
