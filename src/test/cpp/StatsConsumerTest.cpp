...
BOOST_AUTO_TEST_CASE(StatsReaderTest_notifyingShouldSucceed) {
  ...
  std::array<std::unique_ptr<PlayerStatistics>, 10> playerStats {
      std::make_unique<PlayerStatistics>(PlayerStatistics::Params {.playerName = "player1",
                                                                   .siteName = "someSite",
                                                                   .isHero = true,
                                                                   .nbHands = 1,
                                                                   .vpip = 1,
                                                                   .pfr = 1}),
      std::make_unique<PlayerStatistics>(PlayerStatistics::Params {.playerName = "player2",
                                                                   .siteName = "someSite",
                                                                   .isHero = false,
                                                                   .nbHands = 2,
                                                                   .vpip = 2,
                                                                   .pfr = 2}),
      std::make_unique<PlayerStatistics>(PlayerStatistics::Params {.playerName = "player3",
                                                                   .siteName = "someSite",
                                                                   .isHero = false,
                                                                   .nbHands = 3,
                                                                   .vpip = 3,
